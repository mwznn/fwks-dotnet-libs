...
import { ConfirmationDialogComponent, DataDialogComponent } from '@app/components'
...
export class HomeComponent implements AfterViewInit {
  ...
  async openConfirmationDialog(): Promise<void> {
    ...
    dialogRef.afterClosed().toPromise().then(confirmationResult => this.confirmationResult = confirmationResult)
  }
  ...
  async openDataDialog(): Promise<void> {
    ...
    dialogRef.afterClosed().toPromise().then(lastName => this.lastName = lastName)
  }
  ...
  deleteRow(row: CustomerResponse): void {
    ...
    snackBarRef.afterDismissed().toPromise().then(x => {
